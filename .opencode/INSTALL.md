...
- 命名空间前缀: `phoenix:golang-patterns`, `phoenix:systematic-debugging`
- 优先级: project skills > personal skills > phoenix skills
...
ls ~/.config/opencode/skills/phoenix/
```
...
rm -f ~/.config/opencode/skills/phoenix
